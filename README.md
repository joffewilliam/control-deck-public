...
- Windows 10/11 (x64)
- Git
- Optional provider CLIs: Claude Code, Codex, Cursor Agent, OpenCode — install
...
**Do not** paste API keys, tokens, license keys, private prompts, customer data,
or full terminal transcripts into public issues.
...
Control Deck is proprietary software, licensed (not sold) under the
[End User License Agreement](legal/EULA.md). © 2026 William Joffe. All rights
reserved.
